...
public abstract class DoubleGridUploadController<T, V extends ViewBean> extends SingleGridUploadController<T, V> {
	protected static final String DBL_GRID_VIEW_NAME = "common/page/doubleGridPage"; // 默认的JSP
