...
@RequestMapping("/budget/finalVersion")
public class FinalVersionController extends SingleGridController<BudgetFinalVersion, BudgetFinalVersionBean>{
 
    private static final Logger logger = LoggerFactory.getLogger(FinalVersionController.class);
    
    private static final String PID ="P10021";
    ...
    @Override
    protected Service<BudgetFinalVersion, String> getDataService() {
        return this.budgetFinalVersionService;
    }
    ...
    @Override
    protected ViewConverter<BudgetFinalVersion, BudgetFinalVersionBean> getViewConverter() {
        return new BudgetFinalVersionBeanConverter();
    }
