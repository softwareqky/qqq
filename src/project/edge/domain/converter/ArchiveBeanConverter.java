 ...
 */
public class ArchiveBeanConverter implements ViewConverter<Archive, ArchiveBean> {

    @Override
    public ArchiveBean fromEntity(Archive entity, MessageSource messageSource, Locale locale) {
    ...
    @Override
    public Archive toEntity(ArchiveBean bean, Archive oldEntity, AbstractSessionUserBean user,
            Date now) {

        Archive entity = oldEntity;
