 ...
 * 保存项目修改信息的表现层DTO。
 */
public class ProjectChangeBean implements ViewBean {
    ...
    private String changedContentHtmlEscaped;
    ...
    private String changeRemarkHtmlEscaped;
    ...
    public String getChangedContentHtmlEscaped() {
        return this.changedContentHtmlEscaped;
    }

    public void setChangedContentHtmlEscaped(String changedContentHtmlEscaped) {
        this.changedContentHtmlEscaped = changedContentHtmlEscaped;
    }
    ...
    public String getChangeRemarkHtmlEscaped() {
        return this.changeRemarkHtmlEscaped;
    }

    public void setChangeRemarkHtmlEscaped(String changeRemarkHtmlEscaped) {
        this.changeRemarkHtmlEscaped = changeRemarkHtmlEscaped;
    }
