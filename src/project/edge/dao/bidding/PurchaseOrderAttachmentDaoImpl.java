...
@Repository
public class PurchaseOrderAttachmentDaoImpl extends
        HibernateDaoImpl<PurchaseOrderAttachment, String> implements PurchaseOrderAttachmentDao {
     ...
     */
    @Override
    public PurchaseOrderAttachment find(String id) {
        ...
        PurchaseOrderAttachment purchaseOrderAttachment =
                (PurchaseOrderAttachment) session().createCriteria(this.type)
