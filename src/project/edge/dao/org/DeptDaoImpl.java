 ...
 */
@Repository
public class DeptDaoImpl extends HibernateDaoImpl<Dept, String> implements DeptDao {
    ...
    public Dept find(String id) {
        ...
        Dept dept = (Dept) session().createCriteria(this.type)
                .createAlias("org", "o", JoinType.LEFT_OUTER_JOIN).add(Restrictions.eq("id", id))
                .uniqueResult();
        return dept;
    }
}
