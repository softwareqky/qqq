...
@Repository
public class PurchaseTenderingDaoImpl
		extends HibernateDaoImpl<TenderingPurchase, String>
		implements PurchaseTenderingDao{
	@Override
    ...
    public TenderingPurchase find(String id) {
        ...
        TenderingPurchase purchaseTendering =
