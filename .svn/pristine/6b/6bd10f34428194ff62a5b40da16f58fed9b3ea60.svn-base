 ...
 */
@Repository
public class ReviewDaoImpl extends HibernateDaoImpl<Review, String> implements ReviewDao {
    ...
    protected DetachedCriteria prepareConditions(DetachedCriteria criteria, DataFilter filter) {
        ...
        criteria.createAlias("project", "pj", JoinType.LEFT_OUTER_JOIN)
                .createAlias("reviewType", "reviewType", JoinType.LEFT_OUTER_JOIN)
                .createAlias("reviewResult", "reviewResult", JoinType.LEFT_OUTER_JOIN)
                .createAlias("verifyResult", "verifyResult", JoinType.LEFT_OUTER_JOIN)
                .createAlias("reviewStatus", "reviewStatus", JoinType.LEFT_OUTER_JOIN);
    ...
    public Review find(String id) {
        ...
        Review review = (Review) session().createCriteria(this.type)
