...
<body>
  ...
  <g:doubleGridSelector idPrefix="${idPrefix}" gridId="${idMap['main-datagrid']}" gridTitle="${gridTitle}" defaultOrder="${defaultOrder}" listFrozenFields="${listFrozenFields}"
