 ...
 */
@Repository
public class ProjectDaoImpl extends HibernateDaoImpl<Project, String> implements ProjectDao {

    @Override
    public List<Project> list(DataFilter filter, List<OrderByDto> orders, PageCtrlDto page) {
        return getList(filter, orders, page);
    }

    @Override
    public List<Project> list(DataFilter filter, List<OrderByDto> orders) {
    ...
    protected void setListCriteriaAlias(Criteria query) {
        ...
        query.createAlias("site", "site", JoinType.LEFT_OUTER_JOIN)
                ...
                .createAlias("projectStage", "projectStage", JoinType.LEFT_OUTER_JOIN)
        ...
        query.createAlias("projectAttachments", "projectAttachments", JoinType.LEFT_OUTER_JOIN)
                .createAlias("projectAttachments.archive", "archives", JoinType.LEFT_OUTER_JOIN); // one-to-many
    ...
    public Project find(String id) {
        ...
        Project project = (Project) session().createCriteria(this.type)
                ...
                .createAlias("modifier", "modifier", JoinType.LEFT_OUTER_JOIN)
                .createAlias("mainLeader", "mainLeader", JoinType.LEFT_OUTER_JOIN)
                .createAlias("projectAttachments", "projectAttachments", JoinType.LEFT_OUTER_JOIN)
                .createAlias("projectAttachments.archive", "archives", JoinType.LEFT_OUTER_JOIN)
