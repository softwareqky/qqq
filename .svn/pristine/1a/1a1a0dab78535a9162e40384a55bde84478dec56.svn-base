...
<body>
  ...
  <g:treeDoubleGridEasyuiLayout idPrefix="${idPrefix}" filterFormId="${idMap['filter-form']}" listUrl="${urlMap['list']}" searchFunctions="${searchFunctions}" searchFields="${searchFields}"
