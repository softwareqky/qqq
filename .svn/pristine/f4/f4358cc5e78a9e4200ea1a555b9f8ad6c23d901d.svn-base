...
@RequestMapping("/process/project-rewards")
public class ProjectRewardsTypeController extends SingleGridController<DataOption, DataOptionBean> {

    private static final Logger logger =
            LoggerFactory.getLogger(ProjectRewardsTypeController.class);

    private static final String PID = "P60010";
    ...
    public String getDataType() {
        return DataTypeEnum.DATA_OPTION_REWARDS_TYPE.value();
    }
    ...
    public JsonResultBean list(
        ...
        CommonFilter f = new CommonFilter().addExact("dataType",
                DataTypeEnum.DATA_OPTION_REWARDS_TYPE.value());
    ...
    @RequestMapping("/add")
    @ResponseBody
    @SysLogAnnotation(description = "奖罚类型", action = "新增")
    public JsonResultBean create(@ModelAttribute DataOptionBean bean,
            @ModelAttribute(Constants.SESSION_USER) SessionUserBean userBean, Locale locale) {
        bean.setDataType(DataTypeEnum.DATA_OPTION_REWARDS_TYPE.value());
    ...
    @RequestMapping("/edit")
    @ResponseBody
    @SysLogAnnotation(description = "奖罚类型", action = "更新")
    ...
    @ResponseBody
    @SysLogAnnotation(description = "奖罚类型", action = "删除")
