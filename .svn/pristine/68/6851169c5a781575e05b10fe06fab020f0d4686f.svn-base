...
@RequestMapping("/system/map-custom")
public class MapCustomization {

    private static final Logger logger = LoggerFactory.getLogger(MapCustomization.class);

    private static final String PID = "P1120";

    /** 如果在general文件夹中创建了index.jsp，则此处可以是general/index */
    private static final String CUSTOM_VIEW_NAME = "facility/mapCustomization";
     ...
     * @return
     */
    @RequestMapping("/update-defined-icon")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping("/get-defined-icon")
    @ResponseBody
