...
<body>
  ...
  <g:flowableSettingLayout idPrefix="${idPrefix}" filterFormId="${idMap['filter-form']}" listUrl="${urlMap['list']}" searchFunctions="${searchFunctions}" searchFields="${searchFields}"
  ...
  >
    <g:sideFlowableBusinessCodeTree idPrefix="${idPrefix}" treeUrl="${urlMap['tree-side-business-code']}" linkedGridId="${idMap['main-datagrid']}" linkedSubgridId="${idMap['sub-datagrid']}" />
  </g:flowableSettingLayout>
