<%@tag description="左树右grid画面布局中，左侧的项目一览，采用树形结构展示项目集-项目" pageEncoding="UTF-8"%>
          ...
          <div class="container-fluid min-width-200">
            ...
            <div class="row row-gapped-top-s">
              <div class="col-xs-12 col-gapped-left-m col-cell-height-m">
                ...
                <input type="text" class="form-control ez-like" style="width: 158px; vertical-align: middle; display: inline-block;" data-field-widget="textbox" data-field-control maxlength="50"
            ...
            <div class="row row-gapped-top-s">
              <div class="col-xs-12 col-gapped-left-m col-cell-height-m">
                ...
                <select class="form-control ez-like" data-field-widget="combobox" data-field-control style="width: 158px; vertical-align: middle; display: inline-block;">
                  <option value="">&nbsp;</option>
