...
<div class="hidden">
  <div id="${idMap['page-pre']}-AuditSubmitDialog" class="easyui-dialog"
    data-options="title:'提交审核',closed:true,buttons:'#${idMap['page-pre']}-AuditSubmitDialogButtons',iconCls:'icon-func-audit-submit',maxHeight:520,width:650,modal:true,onMove:EasyDialogUtils.onDialogMove"
  >
  ...
  <%-- 提交审核弹出画面的按钮 --%>
  <div id="${idMap['page-pre']}-AuditSubmitDialogButtons">
    <a href="javascript:void(0)" class="easyui-linkbutton" role="button" onclick="EasyDialogUtils.closeFormDialog('#${idMap['page-pre']}-AuditSubmitDialog');">
