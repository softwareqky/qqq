...
<script type="text/javascript">
    ...
    if (!PROJECTINSPECT_EXPERT) {
        var PROJECTINSPECT_EXPERT = (function($) {
             ...
             */
             function onChooseRows(rows) {
                 ...
                 var $parentGrid = $('#P6005-PROJECT_INSPECT-MainDatagrid');
                 var $grid = $('#P6006-PROJECTINSPECT_EXPERT-MainDatagrid');
                 var con = $parentGrid.data('EXTRA_FILTER_OBJ');

                 var param = {};
                 param.projectInspect_ = con.value;
                 param.expertList = [];
