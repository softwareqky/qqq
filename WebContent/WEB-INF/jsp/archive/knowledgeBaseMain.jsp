...
<body>
  ...
  <div class="easyui-layout" data-options="fit:true">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-9 col-gapped-none">
            <%-- 文件功能按钮 --%>
            <button id="P9005F16" type="button" class="btn btn-primary" onclick="${jsMap['open-add-file']}">
              <i class="fa fa-fw fa-upload"></i>
              <s:message code="ui.common.upload.file" />
            </button>
            <button id="P9005F01" type="button" class="btn btn-default" onclick="${jsMap['open-add-folder']}">
              <i class="fa fa-fw fa-folder-o"></i>
              <s:message code="ui.common.add.folder" />
            </button>
            <div class="btn-group" role="group">
              <button id="P9005F17" type="button" class="btn btn-default" onclick="${jsMap['open-download']}">
                <i class="fa fa-fw fa-download"></i>
                <s:message code="ui.common.download" />
              </button>
              <button id="P9005F02" type="button" class="btn btn-default" onclick="${jsMap['open-delete']}">
                <i class="fa fa-fw fa-trash-o"></i>
                <s:message code="ui.common.delete" />
              </button>
              <button id="P9005F03" type="button" class="btn btn-default" onclick="${jsMap['open-edit']}">
                <s:message code="ui.common.modify.info" />
              </button>
              <%-- <button id="P9005F22" type="button" class="btn btn-default" onclick="${jsMap['open-authority']}">
                <s:message code="ui.common.authority" />
              </button> --%>
              <%-- <button id="P9005F51" type="button" class="btn btn-default">
                <s:message code="ui.common.copy.to" />
              </button>
              <button id="P9005F52" type="button" class="btn btn-default">
    ...
    <div data-options="region:'center',border:false,minWidth:830,bodyCls:'knowledge-base-content'" style="padding: 10px 0px;">
      ...
      <table id="${idMap['main-datagrid']}" class="easyui-datagrid"
        data-options="url:'${urlMap['list']}',toolbar:'#${idMap['main-datagrid']}Toolbar',
                ...
                onDblClickRow:KNOWLEDGE_BASE.handleDblClickRow,
                loadFilter:KNOWLEDGE_BASE.datagridLoadFilter,onLoadSuccess:MainUtils.handleDatagridLoadSuccess,onLoadError:MainUtils.handleDatagridLoadError,
                onSelect:KNOWLEDGE_BASE.handleSelect,onUnselect:KNOWLEDGE_BASE.handleSelect,onSelectAll:KNOWLEDGE_BASE.handleSelect,onUnselectAll:KNOWLEDGE_BASE.handleSelect"
      >
        <thead>
          <tr>
            <th data-options="field:'ck',checkbox:true"></th>
            <th data-options="field:'archiveName',width:450,align:'left',sortable:true,formatter:KNOWLEDGE_BASE.archiveNameFormatter">
              <s:message code="ui.fields.knowledge.base.name" />
            </th>
            <th data-options="field:'remark',width:200,align:'left',sortable:false,formatter:MainUtils.remarkFormatter">
              <s:message code="ui.fields.knowledge.base.remark" />
            </th>
            <th data-options="field:'fileSizeText',width:70,align:'left',sortable:true,fixed:true">
              <s:message code="ui.fields.knowledge.base.file.size" />
            </th>
            <th data-options="field:'mDatetime',width:145,align:'left',sortable:true,fixed:true">
              <s:message code="ui.fields.knowledge.base.mdatetime" />
            </th>
            <th data-options="field:'pname',width:130,align:'left',sortable:false,fixed:true,formatter:KNOWLEDGE_BASE.pnameFormatter,hidden:true">
              <s:message code="ui.fields.knowledge.base.pname" />
            </th>
          </tr>
        </thead>
      </table>
